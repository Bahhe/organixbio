        ...
        <div className="w-full">
          <div className="relative mx-auto w-[1116px] border p-10 pt-20">
            ...
            <p className="border-l pl-10 text-pink-800">
              ...
              voluptatum fuga optio, officia repudiandae excepturi explicabo!
              Vel cum obcaecati ad nulla eum asperiores tempora in odio quos
              sapiente consequuntur suscipit voluptatum dolorem, reprehenderit
              soluta voluptatem illum minus quod voluptates rem fugiat quasi
              facilis? Nemo ea, quos recusandae ut eos facere.
            </p>
          </div>
        </div>
      </section>
